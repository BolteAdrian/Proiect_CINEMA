 				...
 				<div class="col-md-8">
 					<div class="card bg-primary">
 						<div class="card-body text-white">
 							...
 							<hr>
 							<p class=""><small><b>Descriere: </b><i><?php echo $mov['description'] ?></i></small></p>
 							<p class=""><small><b>Durata film: </b><i><?php echo $duration ?></i></small></p>
 						</div>
 					</div>
 <!--dupa ce am selectat filmul vom da click pe "Rezerva loc" si se va deschide un formular cu nume, prenume ,numar telefon ...--> 
 					<div class="card bg-light mt-2">
 						<div class="card-body">
 							<h4>Rezervare bilet</h4>
 							<form action="" id="save-reserve">
 								...
 								<div class="row">
 									...
 									<div class="form-group col-md-4">
 										<label for="" class="control-label">Prenume:</label>
 										<input type="text" name="firstname" required="" class="form-control">
 									</div>
 								<div class="form-group col-md-4">
 										<label for="" class="control-label">Numar telefon:</label>
 										<input type="text" name="contact_no" required="" class="form-control">
 									</div>
								</div>
 								<div class="row">
 								<div class="form-group col-md-4">
 									<label for="" class="control-label">Tip:</label>
 								...
 								<div class="row">
 									<button class="col-md-2 btn btn-block btn-primary">Rezerva</button>
 								</div>
 							</form>
