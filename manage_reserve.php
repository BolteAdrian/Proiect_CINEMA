...
?>
 <!--odata ce am trecut numele , prenumele si data de contact vor mai aparea 4 campuri de completat--> 
<div class="row">
	<div class="form-group col-md-4">
	<label for="" class="control-label">Selecteaza zona:</label>
...
<div class="row">
	<div class="form-group col-md-2">
		<label for="" class="control-label">Cantitate:</label>
