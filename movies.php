...
<header class="masthead">
	...
	<?php while($row=$movies->fetch_assoc()): ?>
        <div class="movie-item">
          ...
          <div class="mov-det">
 <!--butonul care apare pe coperta filmului cand ducel cursorul pe film diferenta fata de cel de pe movie_carousel este ca filmul se afla intr-o lista pe alta pagina-->
            <button type="button" class="btn btn-primary" data-id="<?php echo $row['id'] ?>">Rezerva loc</button>
          </div>
        </div>
    <?php endwhile; ?>
