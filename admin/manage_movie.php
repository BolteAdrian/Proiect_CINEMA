	...
	<div class="col-lg-12">
		<form id="manage-movie">
			...
			<div class="form-group row">
				<label for="" class="control-label col-md-12">Durata:</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Data premierei:</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Ultima zi de redare:</label>
			...
			<div class="form-group input-group">
				<label for="" class="control-label">Coperta filmului:</label>
				<br>
				<div class="input-group-prepend">
				    <span class="input-group-text">Incarcare</span>
				  </div>
				  <div class="custom-file">
				    <input type="file" name="cover" class="custom-file-input" id="cover-img" onchange="displayImg(this,$(this))">
				    <label class="custom-file-label" for="cover-img">Alege fisierul</label>
				  </div>
			</div>
	...
	$('#manage-movie').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Datele au fost salvate!','success')
					setTimeout(function(){
						location.reload()
					},1500)
					// end_load()
